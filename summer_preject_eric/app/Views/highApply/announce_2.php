...
<?= $this->section('content') ?>
				...
				for($i=($page-1)*$num_per_page; $i<min($page*$num_per_page, $total_num); $i++) {
					echo '
						<tr>
							...
							<td><a class="text-decoration-none" href="/HighApply/show/'.$posts[$i]['id'].'">'.$posts[$i]['title'].'</a></td>
						</tr>
					';
				}
			} 
	...
	<nav aria-label="Page navigation">
		<ul class="pagination pagination-sm justify-content-center">
			<li class="page-item">
				<a class="page-link link-dark" href="announce_2?page=1" aria-label="Previous">
			...
			for($i=1; $i<=ceil($total_num/$num_per_page); $i++) {
				if($page-3 < $i && $i < $page) {
					echo '<li class="page-item"><a class="page-link link-dark" href="announce_2?page='.$i.'">'.$i.'</a></li>';
				}
				else if($i == $page) {
					echo '<li class="page-item"><a class="page-link link-dark active" href="announce_2?page='.$i.'">'.$i.'</a></li>';
				}
			...
			?>
    		<li class="page-item">
				<a class="page-link link-dark" href="announce_2?page=<?php echo ceil($total_num/$num_per_page) ?>" aria-label="Next">
