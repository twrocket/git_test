...
<?= $this->section('content') ?>
	...
	<nav aria-label="Page navigation">
		<ul class="pagination pagination-sm justify-content-center">
			<li class="page-item">
				<a class="page-link link-dark" href="announce_1?page=1" aria-label="Previous">
			...
			for($i=1; $i<=ceil($total_num/$num_per_page); $i++) {
				if($page-3 < $i && $i < $page) {
					echo '<li class="page-item"><a class="page-link link-dark" href="announce_1?page='.$i.'">'.$i.'</a></li>';
				}
				else if($i == $page) {
					echo '<li class="page-item"><a class="page-link link-dark active" href="announce_1?page='.$i.'">'.$i.'</a></li>';
				}
			...
			?>
    		<li class="page-item">
				<a class="page-link link-dark" href="announce_1?page=<?php echo ceil($total_num/$num_per_page) ?>" aria-label="Next">
