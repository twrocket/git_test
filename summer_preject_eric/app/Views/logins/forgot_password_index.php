				...
				<div class="row align-items-center">
					...
					<div class="col-6" >
						...
						<form action="/LoginController/forgot_password_check" enctype="mutipart/form-data" method="POST">
							...
							<div class="row mb-3">
								<div><label for="inputPassword3" class="col-sm-2 col-form-label" style="font-size: 1.5rem;">電子郵件</label></div>
								<div class="col-sm-13 ">
								<input name="usr_email" type="text" required="true" class="form-control" placeholder="請輸入電子郵件">
								</div>
							</div>
							<div class="row mb-3">
