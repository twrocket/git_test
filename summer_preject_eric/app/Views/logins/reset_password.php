			...
			<div class="container">
				...
				<div class="row align-items-center">
					...
					<div class="col-6" >
						...
						<form action="/LoginController/password_update
                        
                        " enctype="mutipart/form-data" method="POST">
							<div class="row mb-3">
								<div><label for="inputEmail3" class="col-sm-12 col-form-label" style="font-size: 1.5rem; text-align: center;">輸入新密碼</label></div>
								<div class="col-sm-13 ">
