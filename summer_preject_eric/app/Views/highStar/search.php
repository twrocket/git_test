		...
		<table id="contentTable" class="table table-hover table-borderless">
			...
			if(!empty($posts)) {
				...
				foreach($posts as $posts_item) {
					if($posts_item['website'] == "高中繁星" and $posts_item['status_time'] != "已下架" and $posts_item['status'] == "發布") {
                        ...
                        echo '
							<tr>
								...
								<td><a class="text-decoration-none" href="/highStar/show/'.$posts_item['id'].'">'.$posts_item['title'].'</a></td>
							</tr>
						';
                            }                            
